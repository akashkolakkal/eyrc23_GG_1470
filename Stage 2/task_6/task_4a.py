...
############## ADD YOUR CODE HERE	##############
    ...
    # Download the model weights from the link provided in readme.md and save to model_weights/effnet_model_weights
    loaded_model.load_weights("model_weights/effnet_model_weights.h5")
