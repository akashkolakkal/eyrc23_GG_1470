...
'''
# We had actually used a colab notebook for training the model. The code is given below is a replica of the same.
...
EffNet_model.save_weights("EfficientNetV2B3_model_weights.h5")
